...
REFERENCE_VOICE_FILENAME = "voice_preview_mark - cartoonish, funny and cheerful.mp3"
...
def test_t1_f02_04_story_character_voice_mapping():
    ...
    assert REFERENCE_VOICE_FILENAME in ["voice_preview_mark - cartoonish, funny and cheerful.mp3", "ManVoice.mp3", "Vegetarian WolfZ.wav", "Vegetarian Wolf.wav"]
...
def test_t1_f06_03_cache_primary_key_is_omnivoice_k2fsa_model_v1(workflow_yamls):
    ...
    for filename in SECTION_WORKFLOW_MAP.values():
        ...
        assert key in ["omnivoice-k2fsa-models-v6", "omnivoice-k2fsa-models-v5", "omnivoice-k2fsa-models-v4", "omnivoice-k2fsa-models-v3", "omnivoice-k2fsa-models-v2", "omnivoice-k2fsa-model-v1"], f"{filename} cache key is {key}"
